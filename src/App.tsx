...
const DECOR: {
  ...
  },
  {
    ...
    taille: "w-24 sm:w-32 md:w-36 [@media(max-height:500px)]:w-20",
    rotation: "-4deg",
    delai: "-1s",
  },
  {
  ...
  },
  {
    ...
    place: "left-[10%] top-[14%]",
    taille: "w-20 sm:w-24 md:w-28 [@media(max-height:760px)]:hidden",
    rotation: "3deg",
    delai: "-2.2s",
  },
  {
    rendu: (h) => <TRex humeur={h} className="w-full" />,
    place: "right-[10%] top-[16%]",
    taille: "w-24 sm:w-28 md:w-32 [@media(max-height:760px)]:hidden",
    rotation: "-5deg",
    delai: "-0.6s",
  },
  {
    rendu: (h) => <Triceratops humeur={h} className="w-full" />,
    place: "left-[7%] bottom-[16%]",
    taille: "w-24 sm:w-28 md:w-32 [@media(max-height:760px)]:hidden",
    rotation: "4deg",
    delai: "-3.1s",
  },
  ...
  },
  {
    ...
    taille: "w-16 sm:w-20 md:w-24 [@media(max-height:500px)]:w-14",
    rotation: "-6deg",
    delai: "-0.3s",
  },
  {
